...
// Validate ../../src/app/api/notion-nosotros/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/notion-nosotros">> = Specific
  const handler = {} as typeof import("../../src/app/api/notion-nosotros/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
