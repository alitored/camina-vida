    ...
    <section id="metodo" className="px-6 py-24 bg-irlanda-crema relative overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative">
          {/* Línea decorativa de fondo (Desktop) - Ahora usa el color irlanda-verde muy suave */}
            ...
            {pasos.map((p, i) => (
              ...
              >
                ...
                <div className="w-16 h-16 rounded-full bg-white border border-irlanda-verde/10 flex items-center justify-center mb-8 shadow-sm group-hover:border-irlanda-coral group-hover:shadow-xl group-hover:shadow-irlanda-coral/10 transition-all duration-500 bg-white">
                  <span className="text-2xl font-serif text-irlanda-coral">
                    {p.numero}
                  </span>
                </div>
                ...
                <div className="space-y-4">
                  <h3 className="text-xl font-bold text-irlanda-dark tracking-tight group-hover:text-irlanda-coral transition-colors duration-300">
                    {p.titulo}
                  </h3>
                  ...
                  <p className="text-irlanda-dark/60 font-light leading-relaxed text-sm">
                    {p.descripcion}
                  </p>
                </div>
              </motion.div>
        ...
        <div className="mt-20 flex justify-center">
          <motion.div 
            ...
            className="px-8 py-3 rounded-full bg-white border border-irlanda-verde/10 shadow-sm"
          >
            <p className="text-irlanda-coral text-xs font-bold uppercase tracking-widest">
